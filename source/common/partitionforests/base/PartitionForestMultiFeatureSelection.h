...
private:
	struct CompositeListener : CompositeListenerBase<Listener>
	{
		...
		void feature_was_cleared(const Feature& feature, int commandDepth)										{ this->multicast(bind(&Listener::feature_was_cleared, _1, feature, commandDepth)); }
		void modification_redone(const Modification& modification, const Feature& feature, int commandDepth)	{ this->multicast(bind(&Listener::modification_redone, _1, modification, feature, commandDepth)); }
		void modification_undone(const Modification& modification, const Feature& feature, int commandDepth)	{ this->multicast(bind(&Listener::modification_undone, _1, modification, feature, commandDepth)); }
		void multi_feature_selection_changed(int commandDepth)													{ this->multicast(bind(&Listener::multi_feature_selection_changed, _1, commandDepth)); }
		void node_was_identified(const PFNodeID& node, const Feature& feature, int commandDepth)				{ this->multicast(bind(&Listener::node_was_identified, _1, node, feature, commandDepth)); }
		void node_was_unidentified(const PFNodeID& node, const Feature& feature, int commandDepth)				{ this->multicast(bind(&Listener::node_was_unidentified, _1, node, feature, commandDepth)); }
	};
