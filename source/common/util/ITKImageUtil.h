...
std::vector<itk::Offset<Dimension> > make_2d_connected_offsets()
{
	// Construct the vector of offsets in an analogous way to 4-connected in case of 2 dimensions 
	// and 6-connected in case of 3 dimensions for any given number of dimensions.
	// The pattern in case of 4 dimensions gives the result:
	// offsets[0][0] = 0	offsets[0][1] = 0	offsets[0][2] = 0	offsets[0][3] = -1
	// offsets[1][0] = 0	offsets[1][1] = 0	offsets[1][2] = -1	offsets[1][3] = 0
	// offsets[2][0] = 0	offsets[2][1] = -1	offsets[2][2] = 0	offsets[2][3] = 0
	// offsets[3][0] = -1	offsets[3][1] = 0	offsets[3][2] = 0	offsets[3][3] = 0
	// offsets[4][0] = 1	offsets[4][1] = 0	offsets[4][2] = 0	offsets[4][3] = 0
	// offsets[5][0] = 0	offsets[5][1] = 1	offsets[5][2] = 0	offsets[5][3] = 0
	// offsets[6][0] = 0	offsets[6][1] = 0	offsets[6][2] = 1	offsets[6][3] = 0
	// offsets[7][0] = 0	offsets[7][1] = 0	offsets[7][2] = 0	offsets[7][3] = 1

	std::vector<itk::Offset<Dimension> > offsets(2*Dimension);
	for(unsigned int j=0; j<Dimension; ++j)
	{
		offsets[j].Fill(0);
		offsets[j][Dimension - 1 - j] = -1;

		offsets[Dimension+j].Fill(0);
		offsets[Dimension+j][j] = 1;
	}
																   ...
																   const itk::Index<Dimension>& borderSize)
{
	...
	for(unsigned int i=0; i<Dimension; ++i) destSize[i] += 2 * borderSize[i];
