...
BEGIN_EVENT_TABLE_TEMPLATE2(ValidateFeatureSelectionDialog, wxDialog, MFS, Forest)
	//~~~~~~~~~~~~~~~~~~~~ BUTTONS ~~~~~~~~~~~~~~~~~~~~
	EVT_BUTTON(BUTTONID_SAVE_TABLE, ValidateFeatureSelectionDialog::OnButtonSaveTable)

	//~~~~~~~~~~~~~~~~~~~~ CHOICES ~~~~~~~~~~~~~~~~~~~~
	EVT_CHOICE(wxID_ANY, ValidateFeatureSelectionDialog::OnChoiceMFS)

	//~~~~~~~~~~~~~~~~~~~~ UI UPDATES ~~~~~~~~~~~~~~~~~~~~
	EVT_UPDATE_UI(BUTTONID_SAVE_TABLE, ValidateFeatureSelectionDialog::OnUpdateButtonSaveTable)
END_EVENT_TABLE()
