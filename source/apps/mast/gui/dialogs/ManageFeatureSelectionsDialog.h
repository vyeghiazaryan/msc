...
BEGIN_EVENT_TABLE_TEMPLATE2(ManageFeatureSelectionsDialog, wxDialog, MFS, Forest)
	//~~~~~~~~~~~~~~~~~~~~ BUTTONS ~~~~~~~~~~~~~~~~~~~~
	EVT_BUTTON(BUTTONID_CLONE, ManageFeatureSelectionsDialog::OnButtonClone)
	EVT_BUTTON(BUTTONID_CREATE_NEW, ManageFeatureSelectionsDialog::OnButtonCreateNew)
	EVT_BUTTON(BUTTONID_DELETE, ManageFeatureSelectionsDialog::OnButtonDelete)
	EVT_BUTTON(BUTTONID_INTERSECT, ManageFeatureSelectionsDialog::OnButtonIntersect)
	EVT_BUTTON(BUTTONID_LOAD, ManageFeatureSelectionsDialog::OnButtonLoad)
	EVT_BUTTON(BUTTONID_RENAME, ManageFeatureSelectionsDialog::OnButtonRename)
	EVT_BUTTON(BUTTONID_SAVE, ManageFeatureSelectionsDialog::OnButtonSave)
	EVT_BUTTON(BUTTONID_SUBTRACT, ManageFeatureSelectionsDialog::OnButtonSubtract)
	EVT_BUTTON(BUTTONID_SYMDIFF, ManageFeatureSelectionsDialog::OnButtonSymDiff)
	EVT_BUTTON(BUTTONID_UNION, ManageFeatureSelectionsDialog::OnButtonUnion)

	//~~~~~~~~~~~~~~~~~~~~ UI UPDATES ~~~~~~~~~~~~~~~~~~~~
	EVT_UPDATE_UI(BUTTONID_DELETE, ManageFeatureSelectionsDialog::OnUpdateButtonDelete)
	EVT_UPDATE_UI(BUTTONID_INTERSECT, ManageFeatureSelectionsDialog::OnUpdateButtonBinaryOp)
	EVT_UPDATE_UI(BUTTONID_SUBTRACT, ManageFeatureSelectionsDialog::OnUpdateButtonBinaryOp)
	EVT_UPDATE_UI(BUTTONID_SYMDIFF, ManageFeatureSelectionsDialog::OnUpdateButtonBinaryOp)
	EVT_UPDATE_UI(BUTTONID_UNION, ManageFeatureSelectionsDialog::OnUpdateButtonBinaryOp)
END_EVENT_TABLE()
